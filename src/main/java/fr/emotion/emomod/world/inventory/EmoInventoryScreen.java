...
import fr.emotion.emomod.inventory.container.EmoPlayerContainer;
...
@OnlyIn(Dist.CLIENT)
public class EmoInventoryScreen extends DisplayEffectsScreen<EmoPlayerContainer> implements IRecipeShownListener
{
	private static final ResourceLocation RECIPE_BUTTON_TEXTURE = new ResourceLocation("textures/gui/recipe_button.png");
	private static final ResourceLocation INVENTORY_GUI_SCREEN = new ResourceLocation(MainRegistry.MOD_ID, "textures/gui/container/inventory.png");
	...
	public EmoInventoryScreen(PlayerEntity player)
	{
		super(new EmoPlayerContainer(player.inventory), player.inventory, new TranslationTextComponent("container.crafting"));
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		this.minecraft.getTextureManager().bindTexture(INVENTORY_GUI_SCREEN);
		int i = this.guiLeft;
		int j = this.guiTop;
