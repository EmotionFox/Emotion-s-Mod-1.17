...
//	public static final ConfiguredFeature<?, ?> CF_CHERRY_TREE = registerConfiguredFeature("cherry_tree", EMO_TREE.get().configured(FeatureConfiguration.NONE).decorated(ORCHARD_CONFIGURED).count(3));
	...
	public static final ConfiguredFeature<?, ?> CF_HUGE_BLUE_MUSHROOM = registerConfiguredFeature("huge_blue_mushroom",
			HUGE_BLUE_MUSHROOM.get().configured(new HugeMushroomFeatureConfiguration(new SimpleStateProvider(BlockRegistry.BLUE_MUSHROOM_BLOCK.get().defaultBlockState().setValue(HugeMushroomBlock.DOWN, Boolean.valueOf(false))),
					new SimpleStateProvider(net.minecraft.world.level.block.Blocks.MUSHROOM_STEM.defaultBlockState().setValue(HugeMushroomBlock.UP, Boolean.valueOf(false)).setValue(HugeMushroomBlock.DOWN, Boolean.valueOf(false))), 2)));
	public static final ConfiguredFeature<TreeConfiguration, ?> CF_CHERRY_TREE = registerConfiguredFeature("cherry_tree",
			Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(BlockRegistry.LOG_CHERRY.get().defaultBlockState()), new StraightTrunkPlacer(5, 4, 0),
	...
	public static final ConfiguredFeature<TreeConfiguration, ?> CF_PEAR_TREE = registerConfiguredFeature("pear_tree",
			Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(BlockRegistry.LOG_PEAR.get().defaultBlockState()), new StraightTrunkPlacer(5, 4, 0),
					...
					new OrchardFoliagePlacer(ConstantInt.of(2), ConstantInt.of(4), UniformInt.of(3, 7)), new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4)))).ignoreVines().build()));
	public static final ConfiguredFeature<TreeConfiguration, ?> CF_ORANGE_TREE = registerConfiguredFeature("orange_tree",
			Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(BlockRegistry.LOG_ORANGE.get().defaultBlockState()), new StraightTrunkPlacer(5, 4, 0),
